  ...
  return (
    <div>
            ...
            <SwiperSlide key={slide.id}>
              <div className='relative w-full h-full'>
                ...
                <div className='absolute inset-0 bg-black/40 flex items-center justify-center'>
                  <p className='text-white text-2xl sm:text-3xl md:text-4xl font-bold'>{slide.label}</p>
                </div>
              </div>
            </SwiperSlide>
          ))}
      ...
      <div ref={productRef} className='h-[100vh] overflow-y-auto'>
        {loading && page === 1 ? (
          <div className='grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 px-3 sm:px-5 mt-6'>
          ...
          <div>
            {allProducts.length < 1 ? (
              ...
              <div className='grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 px-3 sm:px-5 mt-6'>
                ...
                {loading && (
                  <div className='col-span-2 sm:col-span-3 lg:col-span-4 flex justify-center items-center py-6'>
