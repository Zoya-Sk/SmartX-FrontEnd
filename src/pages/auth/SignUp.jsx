...
export const SignUp = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row px-6 overflow-y-hidden">
      ...
      <div className="w-full md:w-[50%]">
        ...
        {/* FORM */}
        <div className="bg-white rounded-md w-full md:w-[80%] p-3 mt-6 overflow-y-hidden formAnimate1">
          <form className="flex flex-col gap-4 rounded-md w-full md:w-[80%] md:ml-8" onSubmit={submitHandler}>
            <TextField type="text" variant="standard" placeholder="Enter Your First Name"
              label="First Name" fullWidth required size="small"
              onChange={changeHandler} name="firstName" className="ipF" />

            <TextField type="text" variant="standard" placeholder="Enter Your Last Name"
              label="Last Name" fullWidth required size="small"
              onChange={changeHandler} name="lastName" className="ipF" />

            <TextField type="email" variant="standard" placeholder="Enter Your Email"
              label="Email" fullWidth required size="small"
              onChange={changeHandler} name="email" className="ipF" />

            <TextField
              type={showPassword ? "text" : "password"}
              variant="standard" placeholder="Enter the Password"
              label="Password" fullWidth required size="small"
              onChange={changeHandler} name="password" className="ipF"
              InputProps={{
                endAdornment: (
            ...
            <TextField
              ...
              variant="standard" placeholder="Confirm Your Password"
              label="Confirm Password" fullWidth required size="small"
              onChange={changeHandler} name="confirmPassword" className="ipF"
              InputProps={{
                endAdornment: (
                  <InputAdornment position="end">
                    {confirmShowPassword
                      ? <IoEyeSharp size={20} className="cursor-pointer" onClick={() => setConfirmShowPassword(false)} />
                      : <FaEyeSlash size={20} className="cursor-pointer" onClick={() => setConfirmShowPassword(true)} />
                    }
                  </InputAdornment>
                )
              }}
            ...
            <div className="flex items-center">
              <Button variant="contained" size="small" fullWidth className="ipF"
