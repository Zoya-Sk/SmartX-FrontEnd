...
const Login = () => {
    ...
    return (
        <div className='flex overflow-y-hidden px-24'>
            ...
            <div className='w-[50%] mt-8'>
                ...
                {/* login form  */}
                <div className='w-[80%] bg-white rounded-md mt-12 p-6 overflow-y-hidden loginAnimation'>
            ...
            {/* LOGO ANIMATION  */}
            <div className='w-[50%] h-[80vh] flex items-center justify-center mt-6'>
                <LogoAnimation />
            </div>
