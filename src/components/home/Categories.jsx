        ...
        <div className='bg-gray-900 border-t border-b border-gray-700 py-3 mt-2'>
            {loading ? (
                ...
                <div className='flex gap-4 px-6'>
                    {[...Array(6)].map((_, i) => (
                        <div key={i} className='h-28 w-36 bg-gray-700 rounded-xl animate-pulse flex-shrink-0' />
                    ))}
                </div>
                ...
                <div
                    ref={scrollRef}
                    className='flex items-center gap-3 px-6 overflow-x-auto scrollbar-hide'
                >
                    {allCategories.map((category) => (
                        <div
                            ...
                            className='flex-shrink-0 flex flex-col items-center justify-center gap-2 w-36 h-28 bg-gray-800 border border-gray-600 rounded-xl text-sm text-gray-200 font-medium whitespace-nowrap transition-all duration-200 hover:border-yellow-400 hover:bg-gray-750 cursor-pointer group'
                        >
