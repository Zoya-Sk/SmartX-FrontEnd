    ...
    return (
        ...
        onClick={()=>{navigate(`/product-details/${product?._id}`)}}>
            <div className='w-full h-[160px] relative'>
                ...
                >
                    {
                        allProducts.some((item)=> item?._id === product?._id) ? <IoMdHeart size={22} className='text-black' onClick={removeProductHandler}/> : <IoMdHeartEmpty size={22} className='text-black' onClick={addProductToWishlistHandler}/>
                    }
            ...
            <div className='flex flex-col gap-1'>
                ...
                <Typography noWrap sx={{ fontSize: "16px", color: "#d1d5db" }}>
                    {product?.productName}
                </Typography>
