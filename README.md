🛍️ SmartX - Frontend
Smart AI-Enabled Marketplace Platform | Built with React.js + Tailwind CSS
SmartX is a modern, fully responsive, and AI-powered local marketplace web application that connects community-based buyers and sellers in a simple, secure, and intelligent environment. This repository contains the complete frontend of the SmartX platform, built using React.js and Tailwind CSS, and deployed on Vercel.
